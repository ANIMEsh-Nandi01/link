  ...
  return (
    <section className="py-24 relative overflow-hidden" ref={ctaRef}>
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-10 right-20 w-96 h-96 bg-pink-500/20 rounded-full mix-blend-screen filter blur-3xl opacity-40 animate-float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute -bottom-20 left-40 w-80 h-80 bg-violet-500/20 rounded-full mix-blend-screen filter blur-3xl opacity-40 animate-float" style={{ animationDelay: '4s' }}></div>
      </div>
